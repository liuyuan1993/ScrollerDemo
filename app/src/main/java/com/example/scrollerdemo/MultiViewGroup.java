...
public class MultiViewGroup extends ViewGroup {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		Log.i(TAG, "--- onMeasure width is -->" + width);
		Log.i(TAG, "--- onMeasure height is -->" + height);
		Log.i(TAG, "--- onMeasure widthmode is -->" + widthMode);
		Log.i(TAG, "--- onMeasure heightmode is -->" + heightMode);
		...
		for (int i = 0; i < childCount; i++) {
			...
			Log.i(TAG, "--- onMeasure width22222 is -->" + getWidth());
		}
	}
